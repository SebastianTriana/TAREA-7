...
for doc in documents:
    bag = []
    pattern_words = doc[0]
    pattern_words = [lenmatizer.lemmatize(w.lower()) for w in pattern_words]
    for w in words:
...
model.save('chatbot_model_spanish.h5', hist)

print("Modelo entrenado y guardado como 'chatbot_model_spanish.h5'")